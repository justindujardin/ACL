...
S32 dSprintf(char *buffer, U32 bufferSize, const char *format, ...)
{
   ...
   AssertFatal( (U32)len < bufferSize, "dSprintf wrote to more memory than the specified buffer size" );
...
S32 dVsprintf(char *buffer, U32 bufferSize, const char *format, void *arglist)
{
   ...
   AssertFatal( (U32)len < bufferSize, "dVsprintf wrote to more memory than the specified buffer size" );
