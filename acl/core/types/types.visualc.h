...
// Disable various warnings about type casts and conversions that we know to be
// safe
#pragma warning(                                                               \
    disable : 4800) // forcing bool to 'true' or 'false' performance warning
#pragma warning(disable : 4311) // pointer truncation fro const void* to U32
                                // (dictionary hash)
#pragma warning(disable : 4244) // pointer truncation fro const S64 to U32
                                // (dictionary hash)
