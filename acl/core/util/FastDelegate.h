...
//				  * Improved syntax for horrible_cast (thanks Paul
//Bludov).
//				  * Tested on Metrowerks MWCC and Intel ICL
//(IA32)
//				  * Compiled, but not run, on Comeau C++ and Intel
//Itanium ICL. 	27-Jun-04 1.2 * Now works on Borland C++ Builder 5.5
//				  * Now works on /clr "managed C++" code on VC7,
//VC7.1
//				  * Comeau C++ now compiles without warnings.
//				  * Prevent the virtual inheritance case from being
//used on 					  VC6 and earlier, which generate incorrect code.
//				  * Improved warning and error messages. Non-standard
//hacks 					 now have compile-time checks to make them safer.
//				  * implicit_cast used instead of static_cast in many
//cases.
//				  * If calling a const member function, a const class
//pointer can be used.
//				  * MakeDelegate() global helper function added to
//simplify pass-by-value.
...
//					 MSVC and Intel now use a clever hack invented
//by John Dlugosz:
...
//				  * Added FastDelegate::empty() to test if invocation
//is safe (Thanks Neville Franks).
...
//				  * Now tested on Intel ICL for AMD64, VS2005 Beta for
//AMD64 and Itanium.
...
// 12-May-09 * AlexS: Added MakeDelgate overloads which just need a function
// pointer. 14-May-09 * AlexS: Changed MakeDelegate to return function signature
// form delegates
...
template <class T> struct DefaultVoidToVoid { typedef T type; };

template <> struct DefaultVoidToVoid<DefaultVoid> { typedef void type; };

// Translate from 'void' into 'DefaultVoid'
// Everything else is unchanged
template <class T> struct VoidToDefaultVoid { typedef T type; };

template <> struct VoidToDefaultVoid<void> { typedef DefaultVoid type; };
...
//into the 	simplest possible form of member function pointer, using a supplied
//'this' pointer.
...
// |   0				|  0       |   0        | Empty | | !=0
// |(dontcare)|  Invoker   | Static function| |   0                |  !=0     |
// !=0*      | Method call    |
// +--------------------+----------+------------+----------------+
...
public:
  ...
  inline bool IsLess(const DelegateMemento &right) const {
    ...
    // containers.
    return ACLib::dMemcmp(&m_pFunction, &right.m_pFunction,
...
//Hagins) 	Allows boost::function style syntax like: 			FastDelegate< double (int,
//long) >
// instead of:
...
//
//			MakeDelegate(&x, &X::func) returns a fastdelegate of the
//type 			necessary for calling x.func() with the correct number of arguments. 			This
//makes it possible to eliminate many typedefs from user code.
//
////////////////////////////////////////////////////////////////////////////////
...
template <class X, class Y, class RetType>
FastDelegate<FASTDLGT_RETTYPE()> MakeDelegate(Y *x,
...
FastDelegate<FASTDLGT_RETTYPE(Param1)>
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2)>
...
template <class X, class Y, class Param1, class Param2, class Param3,
          class RetType>
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)>
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)>
MakeDelegate(Y *x,
             RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
  return FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)>(x,
                                                                        func);
}
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5)>
MakeDelegate(Y *x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3,
                                      Param4 p4, Param5 p5)) {
  return FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5)>(
      x, func);
}
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6)>
MakeDelegate(Y *x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3,
                                      Param4 p4, Param5 p5, Param6 p6)) {
  return FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5,
                                       Param6)>(x, func);
...
FastDelegate<FASTDLGT_RETTYPE(Param1)>
MakeDelegate(RetType (*func)(Param1 p1)) {
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2)>
MakeDelegate(RetType (*func)(Param1 p1, Param2 p2)) {
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)>
MakeDelegate(RetType (*func)(Param1 p1, Param2 p2, Param3 p3)) {
...
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)>
MakeDelegate(RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
...
// N=7
template <class Param1, class Param2, class Param3, class Param4, class Param5,
          class Param6, class Param7, class RetType>
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6,
                              Param7)>
MakeDelegate(RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                             Param5 p5, Param6 p6, Param7 p7)) {
...
// N=8
template <class Param1, class Param2, class Param3, class Param4, class Param5,
          class Param6, class Param7, class Param8, class RetType>
FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6,
                              Param7, Param8)>
MakeDelegate(RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                             Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
  return FastDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5,
                                       Param6, Param7, Param8)>(func);
}
