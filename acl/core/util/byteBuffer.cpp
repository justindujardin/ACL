...
class PrivateBBData {
public:
  PrivateBBData() : refCount(1), dataSize(0), data(NULL) {}
...
U32 ByteBuffer::getBufferSize() const { return _data->dataSize; }

U8 *ByteBuffer::getBuffer() { return _data->data; }

const U8 *ByteBuffer::getBuffer() const { return _data->data; }

ByteBuffer ByteBuffer::getCopy() const {
  return ByteBuffer(_data->data, _data->dataSize);
}

void ByteBuffer::clear() { dMemset(_data->data, 0, _data->dataSize); }
