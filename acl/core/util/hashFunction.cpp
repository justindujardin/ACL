...
U32 hashPointer(const U8 *k, U32 length, U32 initval) {
  U32 a, b, c, len;
...
U64 hashPointer64(const U8 *k, U32 length, U64 initval) {
  U64 a, b, c, len;
  ...
  while (len >= 24) {
    ...
    b += (k[8] + ((U64)k[9] << 8) + ((U64)k[10] << 16) + ((U64)k[11] << 24) +
          ((U64)k[12] << 32) + ((U64)k[13] << 40) + ((U64)k[14] << 48) +
          ((U64)k[15] << 56));
    c += (k[16] + ((U64)k[17] << 8) + ((U64)k[18] << 16) + ((U64)k[19] << 24) +
          ((U64)k[20] << 32) + ((U64)k[21] << 40) + ((U64)k[22] << 48) +
          ((U64)k[23] << 56));
    mix64(a, b, c);
    k += 24;
    len -= 24;
