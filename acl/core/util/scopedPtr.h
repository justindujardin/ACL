...
template <class T> ScopedPtr<T>::~ScopedPtr() { delete mPtr; }
...
template <class T> inline T &ScopedPtr<T>::operator*() const { return *mPtr; }

template <class T> inline T *ScopedPtr<T>::operator->() const { return mPtr; }

template <class T> inline T *ScopedPtr<T>::get() const { return mPtr; }
