...
namespace ACLib
{
   namespace Platform
   {
      namespace Internal_
      {
         ...
         bool PlatformAssertImpl::shouldDebugBreak(Assert::Type type, const String& message)
         {
         ...
         bool PlatformAssertImpl::notifyUser(Assert::Type type, const String& title, const String& message)
         {
            bool ret = true;
