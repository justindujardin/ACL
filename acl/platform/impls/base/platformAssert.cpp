...
namespace Internal_
{
   ...
   bool PlatformAssertImpl::shouldDebugBreak(Torque::Assert::Type type, const String& message)
   {
      if(type != Torque::Assert::Warning)
   ...
   bool PlatformAssertImpl::notifyUser(Torque::Assert::Type type, const String& title, const String& message)
   {
      bool ret = true;
