...
namespace Internal_
{
   ...
   public:
      ...
      /// class provides its own deadlock detection when TORQUE_DEBUG_THREADING is defined.
      ...
      /// class provides its own ownership check when TORQUE_DEBUG_THREADING is defined.
