...
namespace Internal_
{
   ...
   Win32PlatformObject::Win32PlatformObject()
   {
      ...
      Torque::TypeRebind& factory = getProtectedFactory();
   ...
   Torque::Path Win32PlatformObject::getExecutablePath()
   {
      static String cen;
      if (cen.isEmpty())
      {
         ...
         cen = Torque::PathToPlatform((UTF16*)cen_buf);
   ...
   String Win32PlatformObject::getUserDataDirectory()
   {
      ...
      return Torque::PathToPlatform((UTF16*)szBuffer);
   }
   ...
   bool Win32PlatformObject::touchFile(const Torque::Path& path)
   {
