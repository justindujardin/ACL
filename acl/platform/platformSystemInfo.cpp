...
SystemInfo::SystemInfo()
    : Processor(), memoryInMB(-1), majorVersion(-1), minorVersion(-1),
      bugfixVersion(-1), fullOsName("Uninitialized") {}

SystemInfo::ProcessorInfo::ProcessorInfo()
    : speedInMhz(-1), sseLevel(-1), numLogicalProcessors(-1),
      vendor("Uninitialized"), family("Uninitialized") {}
