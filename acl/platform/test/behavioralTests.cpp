...
#include "platform2/fonts/font.h"
...
#include "platform2/test/fonts/testFontImpl.h"
...
using namespace Torque::FS;
   ...
   public:
      ...
      FontImpl* createFont() { fontImplCt++; if(!fontImpl) fontImpl = new TestFontImpl; return fontImpl; }
      ...
      WindowImpl* createWindow() { windowImplCt++; if(!windowImpl) windowImpl = new TestWindowImpl; return windowImpl; }
   ...
   public:
      ...
      BehaviorTestFixture(UnitTest* test)
      {
         ...
         factory.bind<FontImpl>().to(Delegate<FontImpl*()>(creator, &TestCreator::createFont));
