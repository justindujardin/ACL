...
{   
   ...
   public:
      ...
      /// @returns Threading::Status_Busy if the semaphore could not be acquired because 
      /// its count is already 0 and block was false.
      /// @returns Threading::Status_ObjectInvalid if the semaphore was not successfully created.
      ...
      {
      public:
         ScopedAcquire(Semaphore& s) : mSempahore(s)
         {
            mSempahore.acquire();
         }
