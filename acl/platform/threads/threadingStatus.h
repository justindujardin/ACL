...
enum Status {
  ...
  /// Indicates that the thread/process does not have permission to do the
  /// operation. e.g. a thread which does not own a mutex attempting to unlock
  /// it
  Status_Permission,

  /// Indicates that necessary resources were not able to be allocated.
  /// This may also indicate other general failure, depending on the
  /// implementation.
  Status_Resources,
