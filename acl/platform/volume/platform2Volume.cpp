...
#include "platform/volume/platform2Volume.h"
...
namespace Platform2
{
   ...
   public:
      ...
      {
         return mFile->setPosition(in_newPosition, Torque::FS::File::Begin);
      }
   ...
   {
      Torque::ScopedPtr<Internal_::DirectoryImpl> impl;
   ...
   Torque::Path PlatformDirectory::getName() const
   {
      return mImpl->path;
   }
   ...
   {
      Torque::ScopedPtr<Internal_::FileImpl> impl;
      StrongRefPtr<Internal_::FileSystemImpl> fileSystemImpl;
      Torque::Path path;
      Torque::Path fullPath;
   ...
   Torque::Path PlatformFile::getName() const
   {
      return mImpl->path;
   }
   ...
   {
      Torque::ScopedPtr<Internal_::FileSystemChangeNotifierImpl> impl;
      Vector<Torque::Path> paths;
