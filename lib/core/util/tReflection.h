...
//TypeLimitTemplate(S64,-TORQUE_CONSTANT_S64(9223372036854775807)-1,TORQUE_CONSTANT_S64(+9223372036854775807),true,0);
TypeLimitTemplate(U8, 0,+255U,true,0);
TypeLimitTemplate(U16,0,+65535U,true,0);
TypeLimitTemplate(U32,0,+4294967295U,true,0);
//TypeLimitTemplate(U64,0,TORQUE_CONSTANT_U64(+18446744073709551615),true,0);
...
#define TorqueArraySize(array) sizeof(Private::_ArraySize(array))
