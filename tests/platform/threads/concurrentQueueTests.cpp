...
/// ConcurrentQueue sanity test.  Create a bunch of threads, and have them
/// randomly insert and remove from the queue.
...
void testThreadWorkers(bool blockingPop) {
  ...
  // Create the threads, which will sit idle until we signal the start of the
  // race.
